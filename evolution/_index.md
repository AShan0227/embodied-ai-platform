...
| 002-durable-handoff-artifacts.md | 0.8 | process | 交接文档用稳定引用（PR URL/branch head），避免自失效元数据 |
| 003-cli-subprocess-testing.md | 0.8 | coding | CLI 任务用 subprocess 测试覆盖验证/输出/退出码（PET-9+13 confirmed） |
...
- Total active instincts: 5
- Total archived: 0
- Last curation: 2026-03-18 (manual, PET-13 extraction)
- Next curation: 2026-03-21 (Friday, automated)
